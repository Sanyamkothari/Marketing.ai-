...
// Plan A M35's two seams (a setup source and a header tool) live in `extensions.js`, which imports
// nothing; they are re-exported here so a phase module can keep importing them from the router.
// Phase 1 files import them from `extensions.js` directly (DEC-801).
export {
  MODULES_CHANGED,
