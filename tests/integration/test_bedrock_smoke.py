...
model places related text near itself and unrelated text away from it. `GroundedFakeLLMClient` was
...
def test_a_same_domain_off_topic_question_sits_below_the_genuine_one(
    ...
    says a lexical fake cannot demonstrate. `GroundedFakeLLMClient` hashes words into buckets, so a
