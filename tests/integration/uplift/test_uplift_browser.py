...
def journey(browser: Any, server: Server, workdir: Path, shots: Path) -> Journey:
    ...
    # The Results screen offers "Campaign results" as a flow block (the module's run action).
    page.go_back()
    campaign_link = page.locator(f'a[href="#/campaign/{USE_CASE}/{seen.score_run}"]').first
